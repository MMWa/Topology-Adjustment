...
from forward_distributed_solution.MultiForwardPursueNode import MultiForwardPursueNode
...
class MultiForwardDecentralizedSolution(NodeNetwork):
    ...
    def __init__(self, unit_distance, full_list=None):
        ...
        if full_list is not None:
            ...
            new_node = MultiForwardPursueNode([self.node_list, self.relay_list], self.unit_distance, in_node=self.home_node)
